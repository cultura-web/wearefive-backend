...
VALUES (1,'nombrex','apellidox','admin','12345678','example@correo.com'),
       (2,'cliente1','apellidoCliente1','cliente1','12345678','juanesmoncada123@gmail.com');
...
INSERT INTO modelo_zapato (id, color, costo, preciounitario, descuento, nombre, descripcion, detalle, material,
                           imagenurl, tipo)
VALUES (1, 'negro', 8000, 25000, 50, 'ITADORI', 'Economico y artesanal, proporciona a tus pies la sensación de caminar en el cielo', 'hecho con costuras delicadas y resistentes', 'cuero', 'ejemplo.com', 'bota'),
